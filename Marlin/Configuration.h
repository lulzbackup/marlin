...
//    You must specify the X & Y coordinates of all 3 points
  ...
  #define Z_RAISE_BEFORE_PROBING   LULZBOT_Z_RAISE_BEFORE_PROBING    //How much the extruder will be raised before traveling to the first probing point.
  #define Z_RAISE_BETWEEN_PROBINGS LULZBOT_Z_RAISE_BETWEEN_PROBINGS  //How much the extruder will be raised when traveling from between next probing points
